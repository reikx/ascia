...
*/
    ...
    for i in 0..512{
        engine.particles.push(CParticle{
            position: Vec3{
                x: (20.0 + i as f32) * f32::cos(0.1 * i as f32),
                y: (20.0 + i as f32) * f32::sin(0.1 * i as f32),
                z: 100.0,
            },
    ...
    for _i in 0..65536 {
        for i in 0..512{
            engine.particles[i].position = Quaternion::new(Vec3{
                ...
                y: 0.0,
                z: 1.0,
            },-_i as f32 * 0.01).rotate(&Vec3{
                x: (20.0 + i as f32 * 1.0) * f32::cos(0.03 * i as f32),
                y: (20.0 + i as f32 * 1.0) * f32::sin(0.03 * i as f32),
                z: 100.0,
            });
        }
        let mut v = vec![0;1];
