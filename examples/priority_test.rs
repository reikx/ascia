...
use ascia::ascia::core::MaterialMode::{FLAT, LAMBERT_WITH_SHADOW};
...
*/
    ...
    let mut en2 = SimpleEntity::new(ObjectNode::from(PrimitiveGenerator::cube(200.0,Material{
        color: ColorRGBf32{
            r: 1.0,
            g: 1.0,
            b: 1.0,
    ...
    en2.repr().borrow_mut().position.z = -200.0;
    en2.repr().borrow_mut().direction = Quaternion::new(Vec3{
        x: 1.0,
        y: 1.0,
        z: 1.0,
    },PI * 0.25).normalize();
    ObjectNode::connect(&engine.genesis,&en2.objn);
