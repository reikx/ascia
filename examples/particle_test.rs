...
use ascia::ascia::core::CParticleMode::{ARG, SPHERE};
...
*/
    ...
    let mut en1 = SimpleEntity::new(ObjectNode::from(PrimitiveGenerator::cube(20.0,Material{
        color: ColorRGBf32{
            r: 1.0,
            g: 1.0,
            b: 1.0,
    ...
    for _i in 0..65536 {
        for i in 0..100{
            engine.particles[i].position = Quaternion::new(Vec3{
                x: 0.0,
                y: 0.0,
                z: 1.0,
            },-_i as f32 * 0.05).rotate(&Vec3{
                x: (20.0 + i as f32 * 0.5) * f32::cos(0.03 * i as f32),
                y: (20.0 + i as f32 * 0.5) * f32::sin(0.03 * i as f32),
                z: 100.0,
            });
        }
        for i in 0..100{
            engine.particles[i + 100].position = Quaternion::new(Vec3{
                x: 0.0,
                y: 0.0,
                z: 1.0,
            },-_i as f32 * 0.05 + PI).rotate(&Vec3{
                x: (20.0 + i as f32 * 0.5) * f32::cos(0.03 * i as f32),
                y: (20.0 + i as f32 * 0.5) * f32::sin(0.03 * i as f32),
                z: 100.0,
            });
